    ...
    <section className="min-h-screen bg-primary py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2
            className="text-5xl md:text-6xl font-medium text-accent mb-6"
            style={{fontFamily: "var(--font-vidaloka)"}}>
            About Royal Club
          </h2>
          <div className="h-1 w-24 bg-accent rounded-full mx-auto"></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-3xl font-bold text-primary mb-4">Luxury Redefined</h3>
            ...
            <div>
              <h3 className="text-3xl font-bold text-primary mb-4">Exclusive Membership</h3>
              <p className="text-lg text-secondary leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center">
                ...
                <div className="text-muted text-sm">Premium Vehicles</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent mb-2">30+</div>
                <div className="text-muted text-sm">Years of Excellence</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent mb-2">100+</div>
                <div className="text-muted text-sm">Elite Members</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative bg-card rounded-2xl p-8">
              ...
              />
              <div className="absolute -bottom-4 -right-4 glass-card rounded-lg p-6">
                <h4 className="text-accent font-semibold mb-2">Heritage Collection</h4>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <SpotlightCard
            ...
            <div className="w-12 h-12 bg-accent rounded-lg mb-6 flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 21 21">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-primary mb-4">Certified Authenticity</h3>
          ...
          <SpotlightCard
            ...
            <h3 className="text-xl font-bold text-primary mb-4">Concierge Service</h3>
            <p className="text-muted">
